      ...
      <section>
        <Container>
          <div className="grid min-h-[calc(100vh-5rem)] items-center gap-12 py-16 md:grid-cols-[1.1fr_0.9fr] md:gap-16 md:py-20">
            ...
            <Reveal y={45} duration={0.9} delay={0.12}>
      ...
      <section>
        <Container>
          <div className="grid gap-12 py-24 md:grid-cols-[0.85fr_1.15fr] md:items-center md:gap-20 md:py-32">
            ...
            <Reveal y={35} duration={0.8} delay={0.1}>
              ...
              <div className="grid md:grid-cols-2">
                {values.map((value, index) => (
                  <Reveal
                    ...
                    delay={index * 0.08}
                  >
                    <div className="border-t border-(--color-border) px-0 py-8 md:px-8 md:py-10 first:pt-0 md:first:pt-10">
      ...
      <section>
        <Container>
          <div className="py-24 md:py-32">
            ...
            <Reveal y={35} duration={0.85} delay={0.08}>
              <blockquote className="mx-auto mt-12 max-w-5xl text-center">
