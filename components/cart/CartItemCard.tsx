    ...
    <div className="rounded-2xl border border-white/10 bg-[#1B1B22] p-6 shadow-lg">
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-gray-400">Customized Apparel</p>
        </div>

        <div className="text-right">
          <p className="text-sm text-gray-400">Unit Price</p>

          <p className="text-2xl font-bold">₹{item.unitPrice}</p>
        </div>
      </div>
      ...
      <div className="mt-6 grid grid-cols-2 gap-6 md:grid-cols-4">
        <div>
          ...
          <p className="mt-1 font-medium capitalize">{item.color}</p>
        </div>

        <div>
          <p className="text-xs uppercase tracking-wide text-gray-500">Size</p>

          <p className="mt-1 font-medium uppercase">{item.size}</p>
        </div>

        <div>
          <p className="text-xs uppercase tracking-wide text-gray-500">Print</p>

          <p className="mt-1 font-medium">{printLabel}</p>
        </div>
      ...
      <div className="mt-8 flex items-center justify-between border-t border-white/10 pt-6">
        <div>
          ...
          <p className="text-3xl font-bold">₹{item.totalPrice}</p>
        </div>
